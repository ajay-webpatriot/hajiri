        ...
        <div class="row">
            <div class="col-md-8 col-offset-2">
                ...
                <div class="box box-info">
                    ...
                    ?>
                    <!-- form start -->
                    <form action="" id="edit-labour" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="title" class="col-sm-3 control-label">Name:</label>
                                <div class="col-sm-9">
                                    <input name="name" placeholder="Name" class="form-control" type="text" value="<?php echo (isset($result->holiday_name)) ? $result->holiday_name : ''; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="date" id="date" placeholder="Date" class="form-control datepicker" type="text" value="<?php echo (isset($result->holiday_date)) ? $result->holiday_date : ''; ?>">
...
<script>
    jQuery(document).ready(function () {
       //For Date Picker
        ...
        $("[data-mask]").inputmask();
        jQuery('#edit-labour').submit(function (event) {
            var exp = /^[a-zA-Z ]+$/;
