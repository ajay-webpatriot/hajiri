        ...
        <div class="row">
            <div class="col-md-8 col-offset-2">
                ...
                <div class="box box-info">
                    ...
                    ?>
                    <!-- form start -->
                    <form action="" id="edit-foreman" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            <input type="hidden" name="userid" value="<?php echo (isset($result->user_id)) ? $result->user_id : ''; ?>">
...
<script>
    ...
    jQuery(document).ready(function () {
        ...
        jQuery('#edit-foreman').submit(function (event) {
            ...
            if (ulname.val() == '') {
                ulname.css({'border': '1px solid red', });
                ulname.next().text("Please enter Last name");
                error = 1;
            } else {
                if (ulname.val().match(exp)) {
                    ulname.css({'border': '1px solid green', });
                    ulname.next().text("");
                } else {
                    ulname.css({'border': '1px solid red', });
                    ulname.next().text("Please enter valid Last name");
                    error = 1;
                }
            }
            if (email.val() == '') {
