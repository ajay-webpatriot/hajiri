                    ...
                    <form action="" id="edit-labour" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="title" class="col-sm-3 control-label">Days:</label>
                                <div class="col-sm-9">
                                  <?php 
                                  //print_r($result);
                                  //echo implode(" ",$result);
                                  $days = implode(",",$result);//'Monday,Wendnesday';
                                  ...
                                  $week = array('Saturday','Sunday' ,'Monday','Tuesday' ,'Wendnesday' ,'Thursday' ,'Friday');
                                    ...
                                    foreach ($week as $dayName) {
                                        ...
                                        ?>
                                        <input type='checkbox' name='working_days[]' value="<?= $dayName ?>" <?= $checked ?> ><?= $dayName ?><br>
                                        <?php
                                    } 
                                  ?>
