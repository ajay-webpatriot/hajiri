        ...
        <div class="row">
            <div class="col-md-8 col-offset-2">
                ...
                <div class="box box-info">
                    ...
                    ?>
                    <!-- form start -->
                    <form action="" id="attendance-report" class="form-horizontal" method="GET" enctype="multipart/form-data">
                        <div class="box-body">
...
<script>
    jQuery(document).ready(function(){
        ...
        $('#attendance-report').submit(function(event){
            var error=0;
			...
			var fileDownload = $("select[name='downloadformat']");

			category.css({'border': '1px solid green', });
            category.next().text("");
			fileDownload.css({'border': '1px solid green', });
            fileDownload.next().text("");
            if (organization.val() == '') {
            ...
            if (project.val() == '') {
                ...
                project.next().text("Please select project name");
                error = 1;
            } else {
